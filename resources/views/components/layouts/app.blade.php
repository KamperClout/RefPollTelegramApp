...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-slate-300 min-h-screen flex flex-col justify-items-center">
    <script>
...
{{--                        <!-- тень -->--}}
{{--                    </div>--}}
                {{-- Проверка страницы на наличие навбара    --}}
                <div class="bg-custom flex flex-col w-full min-h-screen" id="darkening">
                    {{ $slot }}
                    @unless (request()->routeIs('choose-login') || request()->routeIs('register') || request()->routeIs('survey'))
